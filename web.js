...
app.configure(function() {
	...
	app.use(Facebook.middleware({
		appId : '666840666680350',
		secret : 'c7a45ca8bd121cd3a543ece4b7bf4dc9'
	}));
});

app.get('/lo', Facebook.loginRequired({
	scope : 'read_stream'
}), function(req, res) {
...
app.get('/feedvestigate', Facebook.loginRequired({
	scope : 'read_stream'
}), feedvestigate.feedvestigate);
